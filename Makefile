...
SOURCES = \
	__init__.py \
	bielefeld_geosuche.py 

PLUGINNAME = bielefeld_geosuche

PY_FILES = \
	__init__.py \
	bielefeld_geosuche.py 

# UI_FILES = bielefeld_geosuche_dockwidget_base.ui
...
test: compile transcompile
	...
	@-export PYTHONPATH=`pwd`:$(PYTHONPATH); \
		...
		python3 -m pytest -v --cov=. --cov-report=term-missing test/ || true
	@echo "----------------------"
